...
export const ResourcesForm = ({ industry: defaultIndustry }) => {
  ...
  useEffect(() => {
    const container = document.querySelector("#res-sub-form-inner-container");
    if (!container) return;
    ...
    const createForm = () => {
      ...
      window.hbspt.forms.create({
        ...
        target: "#res-sub-form-inner-container",
        onFormSubmitted: function () {
          document.querySelectorAll('.res-sub-form-industry-select').forEach(el => {
