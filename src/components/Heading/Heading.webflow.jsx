...
export default declareComponent(Heading, {
    ...
    props: {
        ...
        textColor: props.Variant({
            ...
            options: ["Default", "White", "Teal", "Blue", "Yellow", "Light Purple", "Magenta", "Light Blue", "Lighter Purple", "Inherit"],
        ...
        text: props.Text({
            ...
            tooltip: "Use [[text]] for gradient styling or {{text}} for highlight styling. Example: This is [[gradient text]] and this is {{highlighted text}}",
        }),
        align: props.Variant({
            name: "Text Alignment",
            defaultValue: "left",
